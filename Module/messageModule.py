...
mesDic = dict({"交通資訊": return_flex("交通資訊", trainsitPage()),
               ...
               "長興線": return_flex("長興線", multilePage2("https://imgur.com/OPObZli", "每日行駛",
                                                            "https://imgur.com/reGeKoi", "工作日行駛")),
               "每日行駛": return_img("https://imgur.com/OPObZli", "https://imgur.com/OPObZli"),
               "工作日行駛": return_img("https://imgur.com/reGeKoi", "https://imgur.com/reGeKoi"),
